...
@DefaultCoder(VoidCoder.class)
public class GCDUCustomerBusinessRecordValidationBean {
	...
	public GCDUCustomerBusinessRecordValidationBean(){
		
	}
	
	
	public GCDUCustomerBusinessRecordValidationBean(String recType, String dataType, String ctuRolId, String custIdNum,
			String accntCtryCde, String custName, String lobCde, String clntTypeCde, String hsbcEntryCde,
			Date acctOpenDt) {
		super();
